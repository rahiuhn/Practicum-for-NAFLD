...
feature1
# Running normal LASSO with cv based lambda
l1 <- glmnet(x1,y1,family="binomial", alpha=1, lambda = best_lambda.l1)
```
...
# Running normal LASSO with cv based lambda
l1 <- glmnet(x2,y2,family="binomial", alpha=1, lambda = best_lambda.l2)
```
