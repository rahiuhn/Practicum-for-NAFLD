...
newvariables<-c("Glycated_haemoglobin__HbA1c_", "Systolic_Blood_Pressure" , "Waist_circumference")
...
A <- cbind2(c("","Method","Greedy Matching","Optimal Matching","1:2 Matching",
              "Full Matching","Subclassification", "IPTW","GLM"),
...
```{r}
NAFLD.T2D<-data.frame(method=c(rep("CCA",7),rep("MIte",7),rep("MIps",7)),
                      PSmethod=c(rep(c("Greedy Matching","Optimal Matching","1:2 Matching",
                                       "Full Matching","Subclassification", "IPTW","GLM"),3)),
