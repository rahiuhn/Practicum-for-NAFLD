...
res = lapply(1:boot_rep, function(seed) {
  ...
  Y_cont = traindf$NAFLD_status # Please check this variable, is it NAFLD_status or BMI?
...
```
```{r}
newvariables <- c("Triglycerides","Glycated_haemoglobin__HbA1c_","Waist_circumference","Systolic_Blood_Pressure","White_blood_cell__leukocyte__cou", "Albumin", "Alanine_aminotransferase","Creatinine")
...
subc <- matchit(ps.formula, data = omitNAFLD,
                ...
                subclass = 5)
subc 
subc.t<-matrix(c(3083, 3083), ncol=2, byrow=TRUE)
