...
NAFLD.T2D.HR.est[1] <-exp(summary_greedy[2,2])
NAFLD.T2D.logHR.est[1]<-summary_greedy[2,2]
NAFLD.T2D.se[1]<-summary_greedy[2,3]
NAFLD.T2D.pvalue[1]<-summary_greedy[2,6]
NAFLD.T2D.lowerCI[1]<- exp(summary_greedy[2,7])
NAFLD.T2D.upperCI[1]<- exp(summary_greedy[2,8])

NAFLD.T2D.HR.est[2] <-exp(summary_optimal[2,2])
NAFLD.T2D.logHR.est[2]<-summary_optimal[2,2]
NAFLD.T2D.se[2]<-summary_optimal[2,3]
NAFLD.T2D.pvalue[2]<-summary_optimal[2,6]
NAFLD.T2D.lowerCI[2]<- exp(summary_optimal[2,7])
NAFLD.T2D.upperCI[2]<- exp(summary_optimal[2,8])

NAFLD.T2D.HR.est[3] <-exp(summary_one_two[2,2])
NAFLD.T2D.logHR.est[3]<-summary_one_two[2,2]
NAFLD.T2D.se[3]<-summary_one_two[2,3]
NAFLD.T2D.pvalue[3]<-summary_one_two[2,6]
NAFLD.T2D.lowerCI[3]<- exp(summary_one_two[2,7])
NAFLD.T2D.upperCI[3]<- exp(summary_one_two[2,8])

NAFLD.T2D.HR.est[4] <-exp(summary_full[2,2])
NAFLD.T2D.logHR.est[4]<-summary_full[2,2]
NAFLD.T2D.se[4]<-summary_full[2,3]
NAFLD.T2D.pvalue[4]<-summary_full[2,6]
NAFLD.T2D.lowerCI[4]<- exp(summary_full[2,7])
NAFLD.T2D.upperCI[4]<- exp(summary_full[2,8])

NAFLD.T2D.HR.est[5] <-exp(summary_subc[2,2])
NAFLD.T2D.logHR.est[5]<-summary_subc[2,2]
NAFLD.T2D.se[5]<-summary_subc[2,3]
NAFLD.T2D.pvalue[5]<-summary_subc[2,6]
NAFLD.T2D.lowerCI[5]<- exp(summary_subc[2,7])
NAFLD.T2D.upperCI[5]<- exp(summary_subc[2,8])

NAFLD.T2D.HR.est[6] <-exp(summary_iptw[2,2])
NAFLD.T2D.logHR.est[6]<-summary_iptw[2,2]
NAFLD.T2D.se[6]<-summary_iptw[2,3]
NAFLD.T2D.pvalue[6]<-summary_iptw[2,6]
NAFLD.T2D.lowerCI[6]<- exp(summary_iptw[2,7])
NAFLD.T2D.upperCI[6]<- exp(summary_iptw[2,8])
```
