...
l.mod1<- glmnet(x1,y1,family="binomial",nfolds = 5,alpha=1,lambda = best_lambda.l1)
coef.l.min1 <- coef(l.mod1, s="lambda.min")
...
coef.l.min2 <- coef(l.mod2 , s="lambda.min")
...
newvariables <- c("Age","LDL","Waist_circumference","Disastolic_Blood_pressure_automa","Creatinine","Urate","Vitamin_D","BMIdich","rs1044498_C","rs3480_G","rs4880_A","rs4374383_A","rs236918_C")
